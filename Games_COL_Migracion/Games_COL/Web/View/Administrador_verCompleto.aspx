        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style5" colspan="2">
                    ...
                    <asp:TextBox ID="TB_comentarios" runat="server" Height="79px" TextMode="MultiLine" Width="224px" MaxLength="60" ValidationGroup="1"></asp:TextBox>
                     ...
                     <asp:RegularExpressionValidator ID="validator_comentario" runat="server" ControlToValidate="TB_comentarios" 
                         ErrorMessage="*Ingrese solo letras Y Numeros" ForeColor="Red" ValidationExpression="^[A-Za-z0-9 ñÑ]*$"></asp:RegularExpressionValidator>
