    ...
    <asp:DataList ID="DL_resultado" runat="server" OnItemDataBound="DL_resul_RowDataBound">
        ...
        <tr>
            <td class="auto-style6">
                ...
                <ajaxToolkit:CollapsiblePanelExtender ID="Panel2_CollapsiblePanelExtender" runat="server" BehaviorID="Panel2_CollapsiblePanelExtender" CollapseControlID="HL_post" Collapsed="True" CollapsedSize="30" CollapsedText="HL_post" ExpandedSize="500" SuppressPostBack="True" TargetControlID="Panel2" />
