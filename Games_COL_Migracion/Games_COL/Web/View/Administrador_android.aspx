<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/View/MasterAdministrador.master" AutoEventWireup="true" CodeFile="~/Controller/Administrador_android.aspx.cs" Inherits="View_Administrador_android" %>
    ...
    <table class="w-100">
        <tr>
            <td class="auto-style5">
                ...
                <ajaxToolkit:CollapsiblePanelExtender ID="Panel1_CollapsiblePanelExtender" runat="server" BehaviorID="Panel1_CollapsiblePanelExtender" CollapseControlID="HL_noticia" Collapsed="True" CollapsedSize="30" ExpandControlID="HL_noticias" ExpandedSize="1000" SuppressPostBack="True" TargetControlID="Panel1" />
