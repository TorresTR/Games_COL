<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterUsuario.master" AutoEventWireup="true" CodeFile="~/Controller/usuario_reportar_coment.aspx.cs" Inherits="View_Default" %>
...

    {
        ...
        return (((keyCode >= 48 && keyCode <= 57)&& isShift == false) ||                     
            ...
            <td class="text-center" colspan="2">
                <asp:TextBox ID="TB_motivoR" runat="server" Height="151px" Width="281px" MaxLength="60" ValidationGroup="1" onkeyup = "keyUP(event.keyCode)" 
