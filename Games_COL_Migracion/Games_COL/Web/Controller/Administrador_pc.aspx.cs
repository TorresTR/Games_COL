...
public partial class View_Administrador_pc : System.Web.UI.Page
{
    ...
    protected void datalist_command(object sender, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("vermas"))
        {
            ...
            Response.Redirect("Administrador_verCompleto.aspx?parametro=" + res);
        }
    }
    ...
    protected void BT_vermas_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Administrador_verCompleto.aspx?parametro=" + ID.Trim() + "&userid=" + b);
    }
    ...
    {
        int b = int.Parse(Request.Params["userid"]);
        Response.Redirect("Administrador_xbox.aspx?userid=" + b);
    }

    protected void BT_ps_Click(object sender, EventArgs e)
    {
        int b = int.Parse(Request.Params["userid"]);
        Response.Redirect("Administrador_playstation.aspx?userid=" + b);
    }

    protected void BT_android_Click(object sender, EventArgs e)
    {
        int b = int.Parse(Request.Params["userid"]);
        Response.Redirect("Administrador_android.aspx?userid=" + b);
    }
    ...
    protected void BT_verNoticas_Click(object sender, EventArgs e)
    {
        ...
        int b = int.Parse(Request.Params["userid"]);
        Response.Redirect("Adminsitrador_ver_noticias.aspx?parametro=" + ID.Trim() + "&userid=" + b);
    }
}