...
namespace Logica
{
    public class L_encriptadoDesencriptado
    {
        ...
        public static QueryString EncryptQueryString(QueryString queryString)
        {
            ...
            foreach (string name in queryString)
            {
                ...
                newQueryString.Add(L_encriptadoDesencriptado.Encrypt(nm, "%jetsbdh"), L_encriptadoDesencriptado.Encrypt(val, "%jetsbdh"));
            }
        ...
        public static QueryString DecryptQueryString(QueryString queryString)
        {
            ...
            foreach (string name in queryString)
            {
                nm = L_encriptadoDesencriptado.DecryptString(name, "%jetsbdh");
                val = System.Web.HttpUtility.UrlDecode(L_encriptadoDesencriptado.DecryptString(queryString[name], "%jetsbdh"));
